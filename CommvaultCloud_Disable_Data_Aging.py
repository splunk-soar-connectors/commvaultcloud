...
def disable_data_aging(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    for container_artifact_item in container_artifact_data:
        if container_artifact_item[0] is not None:
            parameters.append({
                "client_id": container_artifact_item[0],
    ...
    phantom.act("disable_data_aging", parameters=parameters, name="disable_data_aging", assets=["commvault anomaly detection_draft_clone_1706114511026_clone_1706114511212"], callback=filter_1)
